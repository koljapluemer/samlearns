...
from triangles.interactors.user_dependent_learning_object.topic.user_should_get_image_instead_of_cloze_exercise import user_should_get_image_instead_of_cloze_exercise
