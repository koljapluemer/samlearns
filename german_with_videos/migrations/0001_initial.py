    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='videos', to='german_with_videos.tag')),
            ],
        ),
        migrations.CreateModel(
            name='Snippet',
            fields=[
                ...
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='snippets', to='german_with_videos.video')),
            ],
            options={
                'ordering': ['index'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occurs_in_snippets', models.ManyToManyField(blank=True, related_name='words', to='german_with_videos.snippet')),
                ('videos', models.ManyToManyField(blank=True, related_name='words', to='german_with_videos.video')),
            ],
        ),
        migrations.CreateModel(
            name='Meaning',
            fields=[
                ...
                ('snippet_context', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='meanings', to='german_with_videos.snippet')),
                ('word', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meanings', to='german_with_videos.word')),
            ],
        ),
    ]
