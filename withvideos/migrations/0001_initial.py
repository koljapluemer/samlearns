    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tags', models.ManyToManyField(blank=True, related_name='videos', to='withvideos.tag')),
            ],
        ),
        migrations.CreateModel(
            name='Snippet',
            fields=[
                ...
                ('video', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='snippets', to='withvideos.video')),
            ],
            options={
                'ordering': ['index'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('occurs_in_snippets', models.ManyToManyField(blank=True, related_name='words', to='withvideos.snippet')),
                ('videos', models.ManyToManyField(blank=True, related_name='words', to='withvideos.video')),
            ],
        ),
        migrations.CreateModel(
            name='Meaning',
            fields=[
                ...
                ('snippet_context', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='meanings', to='withvideos.snippet')),
                ('word', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='meanings', to='withvideos.word')),
            ],
        ),
    ]
